...
(
	...
	CONSTRAINT PK_POLICYCARD PRIMARY KEY (CANDIDATEID, POLICYID)
)
...
--CREATE TABLE CandidURLS
--(
--	URLID INT NOT NULL,
--	CANDIDATEID INT NOT NULL,
--	LINK TEXT NOT NULL,
--	CONSTRAINT FK_CANDIDATEID_URLS FOREIGN KEY (CANDIDATEID)
--		REFERENCES CANDIDATE (CANDIDATEID),
--	CONSTRAINT PK_CANDIDATEURL PRIMARY KEY (URLID, CANDIDATEID)
--)
