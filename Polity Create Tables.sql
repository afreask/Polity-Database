...
CREATE TABLE PolicyCardTitles
(
	POLICYCARDTITLEID INT IDENTITY(1,1),
	POLICYID INT NOT NULL,
	POLICYTITLENAME VARCHAR(500) NOT NULL,
	CONSTRAINT PK_PolicyCardTitles PRIMARY KEY (POLICYCARDTITLEID),
	CONSTRAINT FK_PolicyCardTitles_POLICYID FOREIGN KEY (POLICYID)
		REFERENCES Policies (POLICYID)
)